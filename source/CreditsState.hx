...
class CreditsState extends MusicBeatState
{
	...
	private static var creditsStuff:Array<Dynamic> = [ //Name - Icon name - Description - Link - BG Color
		["Mokey MOD"],
		['ReddudeXD',		'reddudexd',	"Creator of the MOD\nAlso is Chilean",				'https://twitter.com/reddudemodderxd',	0xFFF73838],
		["Mokey's Show Characters"],
		['Sr Pelo',		        'srpelo',	        "Creator of the Mokey's Show\nAlso FUNNI",				'https://twitter.com/_srpelo_',	0xFFFFFFFF],
		['Psych Engine Team'],
	...
	override function create()
	{
		...
		bg = new FlxSprite().loadGraphic(Paths.image('mokeySuSDesat'));
		add(bg);
