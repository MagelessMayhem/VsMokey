...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Hide HUD', "1: hud invisible\n 0: hud visible"],
		['Black Void Appear', "this only works on the KrampusStage stage"],
		['Black', "Show a blackscreen.\n Value 1: Alpha\n Value 2: Fade"],
		['Change Position', "Change a Character Position.\n\nValue 1: Character (0 = Dad, 1 = BF, 2 = GF).\nValue 2: Position 'X, Y'"]
	];
